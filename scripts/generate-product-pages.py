...
""",
    },
    {
        ...
        "content": """
<h2>ECG-6型 心、脑电图机检定仪技术参数</h2>
<ol>
<li>采用7英寸触摸屏，中文菜单提示操作，根据规程的检定项目顺序编制有检定程序，能直接显示要检定的各种参数；采用快捷键，可快速切换检测项目。方便使用。</li>
<li>可产生方波信号、正弦波信号、三角波、ECG仿真信号等；<br>
幅度（峰峰值）范围:8.00μV～30.00V；<br>
最大允许误差：80.0μV～30.00V ±0.5%；50.0μV～80.0μV±1%；8.00μV～50.0μV ±5%。</li>
<li>方波信号: 周期范围：2ms～100s，最大允许误差: ±0.1%</li>
<li>正弦波信号: 频率范围:10mHz～500Hz ；频率最大允许误差：±0.1% ；失真度＜2%</li>
<li>三角波：周期范围：2ms～50s，周期最大允许误差：±0.1%</li>
<li>ECG仿真信号：频率0.75Hz， 周期最大允许误差: ±0.1%；</li>
<li>标准心率信号 (正负2种极性）：心率范围：（10.0～500）次／分钟；<br>
心率最大允许误差：±0.1%；<br>
幅度范围: 4.00μV～15.00V，幅度最大允许误差：±1%；</li>
<li>具有自动测量功能，一键完成各个《JJG543-2026心电图机》要求的全部信号的输出。</li>
<li>内置平衡衰减器:衰减比 1/1000；最大允许误差±0.3%</li>
<li>极化电压: 直流：±150mV，±300mV，±600mV，±800mV；<br>
在±300mV最大允许误差不大于±5%。</li>
<li>共模抑制比检定装置:<br>
电压量程:9V-11V（有效值）；电压最大允许误差:±5%;<br>
输入阻抗:>300MΩ,频率:(50±1)Hz,等效输出电容:200pF</li>
<li>主机为手持式，主机内置容量≥11000mAh锂电池，方便现场检测；</li>
<li>符合国家规程：<br>
《JJG543-2026心电图机》、《JJG1042-2008动态(可移动)心电图机》、<br>
《JJG954-2019数字脑电图仪》 的技术要求，</li>
<li>可检定心电图机、动态心电图机、数字脑电图仪。</li>
</ol>
""",
    },
    {
